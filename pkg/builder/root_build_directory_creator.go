...
func (dc *rootBuildDirectoryCreator) GetBuildDirectory(ctx context.Context, actionDigestIfNotRunInParallel *digest.Digest, multinodeTaskIndex int32) (BuildDirectory, *path.Trace, error) {
